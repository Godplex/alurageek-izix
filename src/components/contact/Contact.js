                ...
                <div className="row">
                    ...
                    <div className="col-md-7 col-lg-6">
                        ...
                        <div className="form-row">
                            <input type="name" required className="form-control form-control-lg py-3 mt-3" />
                            <label alt="Label" data-placeholder="Nombre"></label>
                        </div>
                        <textarea type="text" className="form-control form-control-lg mb-3 pt-3" placeholder="Escribe tu mensaje" rows={3}></textarea>
