                ...
                <div className="row">
                    ...
                    <form className="col-md-7 col-lg-6" onSubmit={onSubmit}>
                        ...
                        <div className="form-floating mb-3">
                            <input type="name" name="name" className="form-control" id="floatingInputName" placeholder="Nombre" maxLength={40} value={name} onChange={handleInputChange} required />
                            <label htmlFor="floatingInputName">Nombre</label>
                        </div>
                        <div className="form-floating mb-3">
                            <textarea type="text" name="message" className="form-control" placeholder="Escribe tu mensaje" id="floatingTextareaMessage" style={{ height: 100 }} maxLength={120} value={message} onChange={handleInputChange} required></textarea>
